...
<form name="service1" onsubmit="return validateForm()" action="service"  method="POST">
	<div class="container">
	<div class="row">
		<div class="col-md-9">
 		 ...
 		 <input type="text" name="spname" style="border:1px solid black;width:280px;height:30px;">
...
<div class="row">
		...
		<input type="text" name="orderno" style="border:1px solid black;width:280px;height:30px;">
...
<br>
 &nbsp;&nbsp;Contact No:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="text" name="usrtel" style="border:1px solid black;width:280px;height:30px;">
<br>
<br>
...
<div class="container">
	...
	<div class="row">
     ...
     <center><input type="submit" name="Add" value="Add" style="width:90px;"></center>
 </div>
<br>
</div>	
</form>
		...
		<table>
			...
			<%
				try {
					...
					String query = "select * from sp_mst order by sp_sno";
			...
			<tr>
				...
				<td><button type="submit" name="Submit123" value=<%=sp_sno%>><u>Update</u></button></td>
			</tr>
			<%
				conn.close();
					}
